                            ...
                            <div class="col-sm-6 col-lg-2 col-xs-6 col-md-2 change-size" style="height:fit-content; margin: 10px 10px 0 50px; border: 8px;">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{url('responsive_filemanager/source')}}/{{$product_by_catgr->image_product}}" style="width: 180px; height: 180px;">
                                        </div>

                                        <div class="product-overlay " style= opacity:85%;>
                                            <div class="overlay-content" style="height: fit-content">
                                                <h4 style="color: black;"><bold>{{$product_by_catgr->products_name}}</bold></h4>
                                                <p>{!! $product_by_catgr->products_description!!}</p>
                                ...
                                <div class="container1">
                                    <a href="" style="text-decoration: none; color: black; transition: .3s ease-in;" class="item-name-hover">
                                        <p style="transition: .3s ease-in; text-align: center; font-weight: bold;top: 50%; left: 50%;font-size: 18px">{{$product_by_catgr->products_name}}</p>
                                    </a>
                                    <br>
                                    <a style="padding-bottom: 10px; font-weight: bold; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);" href="{{route('detailPrdpage', $product_by_catgr->id)}}" class="btn btn-default add-to-cart"><i class="fa fa-eye"></i>Chi tiết</a>
                                </div>
                            </div>
                        @endif
                    @endforeach
