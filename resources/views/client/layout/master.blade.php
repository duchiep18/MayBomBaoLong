...
<head>
 ...
 ============================================ -->
    ...
    <link rel='stylesheet' property='stylesheet' href="{{ asset('frontend/haian/css/themecss/cpanel.css') }}"
...
<body class="common-home res layout-home1">
                                                                ...
                                                                @foreach ($all_categories_prd as $category_prd)
                                                                    <li class="item-vertical">
                                                                        ...
                                                                        <a href="{{ route('ProductsbyCatgr', $category_prd->id) }}"
                                                                            ...
                                                                            <strong>
                                                                                <span>
                                                                                    {{ $category_prd->product_categories_name }}</span>
                                                                                <span>
                                                                                    {{ $category_prd->product_categories_id }}</span>
                                                                            </strong>
                                                                        </a>
                                                                    </li>
                                                                @endforeach
                ...
                <div class="container">
                            ...
                            <div class="slider-container ">
                                <div id="so-slideshow" class="">
                                    <div class="module slideshow no-margin">
                                        <div class="item">
                                            <a href="#"><img class="lazyload img-responsive"
                                                    src="{{ asset('frontend/haian/image/demo/slider/sl11/1.jpg') }}"
                                                    alt="slider1"></a>
                                            <div class="sohomeslider-description">
                                                <img class="image image-sl11 pos-right img-active"
                                                    src="{{ asset('frontend/haian/image/demo/slider/sl11/2.png') }}"
                                                    alt="slideshow">
                                                <div class="text pos-right text-sl11">
                                                    <h3 class="tilte modtitle-sl11  title-active">Nikon D7100</h3>
                                                    <p class="des des-sl11 des-active">Ultimate image quality. Create
                                                        without limination</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="item">
                                            <a href="#"><img
                                                    src="{{ asset('frontend/haian/image/demo/slider/sl12/1.jpg') }}"
                                                    alt="slider1"></a>
                                            <div class="sohomeslider-description">
                                                <img class="image image-sl12 pos-left img-active"
                                                    src="{{ asset('frontend/haian/image/demo/slider/sl12/2.png') }}"
                                                    alt="slideshow">
                                        ...
                                        <div class="item">
                                            <a href="#"><img class="lazyload img-responsive"
                                                    src="{{ asset('frontend/haian/image/demo/slider/sl13/1.jpg') }}"
                                                    alt="slider1"></a>
                                            <div class="sohomeslider-description">
                                                <img class="image image-sl13 pos-right img-active"
                                                    src="{{ asset('frontend/haian/image/demo/slider/sl13/2.png') }}"
                                                    alt="slideshow">
                    ...
                    <div class="block-banner banners banner-sn-1 wow fadeInUp">
                        <div class="img-1 banner1-1">
                            <a title="Static Image" href="#"><img class="lazyload img-responsive"
                                    data-sizes="auto"
                                    data-src="{{ asset('frontend/haian/image/demo/banner/m1.jpg') }}"
                                    alt="Static Image"></a>
                        </div>
                        <div class="img-1 banner1-2">
                            <a title="Static Image" href="#"><img class="lazyload img-responsive"
                                    data-sizes="auto"
                                    data-src="{{ asset('frontend/haian/image/demo/banner/m2.jpg') }}"
                                    alt="Static Image"></a>
                        </div>
                        <div class="img-1 banner1-3">
                            <a title="Static Image" href="#"><img class="lazyload img-responsive"
                                    data-sizes="auto"
                                    data-src="{{ asset('frontend/haian/image/demo/banner/m3.jpg') }}"
                                    alt="Static Image"></a>
                        </div>
                        <div class="img-1 banner1-4">
                            <a title="Static Image" href="#"><img class="lazyload img-responsive"
                                    data-sizes="auto"
                                    data-src="{{ asset('frontend/haian/image/demo/banner/m4.jpg') }}"
                                    alt="Static Image"></a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="module ">
                                <div class="content-block-footer">
                                    <div class="footer-logo">
                                        <a href="index.html"><img class="lazyload img-responsive" data-sizes="auto"
                                                src="{{ asset('frontend/haian/image/demo/logos/theme_logo.png') }}"
                                                title="Your Store" alt="Your Store" /></a>
                                    </div>
    ...
    <div id="sp-cpanel" class="sp-delay">
        <h2 class="sp-cpanel-title"> Demo Options <span class="sp-cpanel-close"> <i class="fa fa-times">
                </i></span>
        </h2>
            ...
            <div class="panel-group">
                ...
                <div class="group-pattern">
                    <div data-pattern="28" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/28.png') }}" alt="pattern 28"></div>
                    <div data-pattern="29" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/29.png') }}" alt="pattern 29"></div>
                    <div data-pattern="30" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/30.png') }}" alt="pattern 30"></div>
                    <div data-pattern="31" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/31.png') }}" alt="pattern 31"></div>
                    <div data-pattern="32" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/32.png') }}" alt="pattern 32"></div>
                    <div data-pattern="33" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/33.png') }}" alt="pattern 33"></div>
                    <div data-pattern="34" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/34.png') }}" alt="pattern 34"></div>
                    <div data-pattern="35" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/35.png') }}" alt="pattern 35"></div>
                    <div data-pattern="36" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/36.png') }}" alt="pattern 36"></div>
                    <div data-pattern="37" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/37.png') }}" alt="pattern 37"></div>
                    <div data-pattern="38" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/38.png') }}" alt="pattern 38"></div>
                    <div data-pattern="39" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/39.png') }}" alt="pattern 39"></div>
                    <div data-pattern="40" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/40.png') }}" alt="pattern 40"></div>
                    <div data-pattern="41" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/41.png') }}" alt="pattern 41"></div>
                    <div data-pattern="42" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/42.png') }}" alt="pattern 42"></div>
                    <div data-pattern="43" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/43.png') }}" alt="pattern 43"></div>
                    <div data-pattern="44" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/44.png') }}" alt="pattern 44"></div>
                    <div data-pattern="45" class="img-pattern"><img class="lazyload" data-sizes="auto"
                            src="{{ asset('frontend/haian/image/theme/patterns/45.png') }}" alt="pattern 45"></div>
                </div>
