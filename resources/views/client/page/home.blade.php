                                        ...
                                        <div class="right-block">
                                            <div class="caption">
                                                ...
                                                <h4><a href="product.html" target="_self" title="Juren tima chuk..">Elivers
                                                        chukalen..</a></h4>
                                                <p class="price">
                                                    <span class="price-new">$82.40</span> <span
                                    ...
                                    <div class="product-thumb transition product-item-container">
                                        ...
                                        <div class="right-block">
                                            <div class="caption">
                                                ...
                                                <h4><a href="product.html" target="_self" title="Juren tima chuk..">Sende
                                                        cuisei in..</a></h4>
                                                <p class="price">
                                                    <span class="price-new">$82.40</span> <span
                                                        class="price-old">$122.00</span>
                                    ...
                                    <div class="product-thumb transition product-item-container">
                                        ...
                                        <div class="right-block">
                                            <div class="caption">
                                                ...
                                                <h4><a href="product.html" target="_self" title="Juren tima chuk..">Juren
                                                        tima chuk..</a></h4>
                                                <p class="price">
                                                    <span class="price-new">$82.40</span> <span
                                                        class="price-old">$122.00</span>
                                    ...
                                    <div class="product-thumb transition product-item-container">
                                        ...
                                        <div class="right-block">
                                            <div class="caption">
                                                ...
                                                <h4><a href="product.html" target="_self" title="Juren tima chuk..">Caras
                                                        tima chuk..</a></h4>
                                                <p class="price">
                                                    <span class="price-new">$82.40</span> <span
                                                        class="price-old">$122.00</span>
                        ...
                        <div class="spcat-tabs-container" data-delay="300" data-duration="600" data-effect="flip"
                            ...
                            <div class="spcat-tabs-wrap">
                                ...
                                <ul class="spcat-tabs cf">
                                    ...
                                    <li class="spcat-tab " data-active-content=".items-category-p_sort_order"
                                        data-field_order="p_sort_order">
                                        <span class="spcat-tab-label">Sort Order</span>
                                    </li>
                                    <li class="spcat-tab" data-active-content=".items-category-rating"
                                                ...
                                                <div class="item-inner">
                                                    <div class="cat_slider_title">
                                                        ...
                                                        <a href="category.html" title="Tange manue" target="_self">
                                                            <i class="fa fa-caret-right"></i> Egante mangetes
                                                        </a>
                                                    </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="right-block">
                                                        <div class="caption">
                                                            ...
                                                            <p class="price">
                                                                <span class="price-new">$45.00</span> <span
                                                                    class="price-old">$69.00</span>
                        ...
                        <div class="spcat-tabs-container" data-delay="300" data-duration="600" data-effect="flip"
                            ...
                            <div class="spcat-tabs-wrap">
                                ...
                                <ul class="spcat-tabs cf">
                                    ...
                                    <li class="spcat-tab tab-sel tab-loaded"
                                        data-active-content=".items-category-rating" data-field_order="rating">
                                        <span class="spcat-tab-label">Rating</span>
                                    </li>
                                    <li class="spcat-tab " data-active-content=".items-category-p_quantity"
                                        data-field_order="p_quantity">
                        ...
                        <div class="main-left">
                            <div class="banner-post-text">
                                <a href="#" title="banner"> <img
                                        src="{{ asset('frontend/haian/image/demo/banner/s21.jpg') }}" alt="banner">
                                </a>
                            </div>
                            <div class="hot-category">
                                <div class="category-wrap-cat">
                ...
                <div id="so_super_category_3" class="so-sp-cat first-load">
                    <div class="spcat-wrap ">
                        <div class="spcat-tabs-container" data-delay="300" data-duration="600" data-effect="flip"
                            ...
                            <div class="spcat-tabs-wrap">
                                ...
                                <ul class="spcat-tabs cf">
                                    ...
                                    <li class="spcat-tab tab-sel tab-loaded"
                                        data-active-content=".items-category-p_price" data-field_order="p_price">
                                        <span class="spcat-tab-label">Price</span>
                                    </li>
                                </ul>
                            </div>
                                        ...
                                        <div class="cat_slider_inner so_category_type_default">
                                            ...
                                            <div class="item">
                                                <div class="item-inner">
                                                    <div class="cat_slider_title">
                                                        <a href="category.html" title="Latenge mange" target="_self">
                                                            <i class="fa fa-caret-right"></i> Verture agoent
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="main-right">
                            <div class="banner-pre-text">
                                <a href="#" title="banner"> <img
                                        src="{{ asset('frontend/haian/image/demo/banner/t23.jpg') }}"
                                        alt="banner"></a>
                            </div>
