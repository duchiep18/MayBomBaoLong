...
@section('content')
    ...
    <section class="content">
        <div class="box-body">
            @csrf
            <h2 style="text-align: center">Chỉnh sửa slide-banner</h2>
            <br>
            <br>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="margin-top: 25px; padding: 0px 16px 6px 20px;">
                <div class="card" style="border: 1px solid #9E9E9E; border-radius: 10px">
                    ...
                    <form action="{{route('update_slide_banner', $imgEdit->id)}}" method="POST" role="form">
                        @csrf
                        @method('put')
                        <div class="body" style="height:fit-content">
                            <div style="">
                                <span> Tên ảnh: </span>
                                <input type="text" class="form-control"  value="{{$imgEdit->name_img}}" name="img_name" id="name">
                                <br>
                                <span> Url: </span>
                                <input type="text" class="form-control" value="{!!$imgEdit->url!!}" name="img_url" id="image">

                                <br>
                                <span> Kiểu ảnh: </span>
                                <select name="img_type" id="">
                                        <option {{request()->input('img_type') == "0" ? 'selected': ''}} value="0">Ảnh Slider</option>
                                        <option {{request()->input('img_type') == "1" ? 'selected': ''}} value="1">Ảnh Banner</option>
                                </select>
                                <br>
                                <br>
                                <span>
                                ...
                                <br>
                                <br>
                                <img src="{{$imgEdit->url}}" alt="" id="show_image"  style="height:250px; width:250px; margin-bottom: 10px">
                                <br>

                            </div>
                            <br>
                            <button type="submit" class="btn btn-primary" style="float: left"> Sửa ảnh </button>
                            <br>
                        </div>
                    </form>
                </div>
