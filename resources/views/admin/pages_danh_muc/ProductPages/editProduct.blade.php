                ...
                <div class="row">
                    <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                        ...
                        <div class ="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-left: 0px;">
                            <input type="text" class="form-control" name="name_products" id="name" onkeyup="ChangeToSlug();" placeholder="Tên sản phẩm" value="{{$product->products_name}}" style="width: 100%; height: 40px; background-color:white">
                        </div>
                        ...
                        <div class ="col-xs-12 col-sm-12 col-md-5 col-lg-5"  style="padding-left:0" >
                            <p>Giá sản phẩm:</p>
                            <input type="text" name="price" class="form-control" value="{{$product->price}}" style="background-color: white;margin-top: -10px;">
                        </div>
                        <br>
                        <div class ="col-xs-12 col-sm-12 col-md-5 col-lg-5" style="padding-left:50px" >
                            <p>Giá khuyến mãi:</p>
                            <input type="text" name="price_sale" class="form-control" value="{{$product->sale_price}}" style="background-color: white;margin-top: -10px;">
                        </div>
                        <br>
                        {{-- URL sản phẩm --}}
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 25px; padding: 0px 16px 6px 0px;">
                            <div class ="col-xs-12 col-sm-12 col-md-5 col-lg-5"  style="padding-left:0" >
                                <p>Url sản phẩm:</p>
                                <input type="text" name="url_prd" id="slug" class="form-control" value="{{$product->url_prd}}" style="background-color: white;margin-top: -10px;">
                            </div>
                        </div>
                        <br>
                        <!--Ảnh đại diện-->
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" style="margin-top: 25px; padding: 0px 16px 6px 0px;">
                            ...
                            <div class="card" style="border: 1px solid #9E9E9E; border-radius: 10px">
                                ...
                                <div class="body" style="height:fit-content">
                                    <?php
                                      $image_list = json_decode($product->image_list_product);
                                    ?>
                                    <div style="">
                                        <input type="hidden" class="form-control" name="image_list" id="image_list" value="{{$product->image_list_product}}">
                                        <br>
                            ...
                            <div class="card" style="border: 1px solid #9E9E9E; border-radius: 10px">
                                ...
                                <div class="body">
                                    <div style="margin: 10px">
                                        <input type="text" id="tags" name="tags_prd" value="{{$product->tags}}" class="form-control">
                                        <br>
                                    ...
                                    <div class="body">
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade in active" id="home">
                                                ...
                                                <div style="margin:0 10px 10px 10px;">
                                                    <input type="checkbox" checked name="status" value="Còn hàng"
                                                ...
                                                <div style="margin:0 10px 10px 10px;">
                                                    <input type="checkbox" checked name="status" value="Hết hàng"
                                                           id="basic_checkbox_2" class="filled-in"/>
                                                    <label for="basic_checkbox_2">Hết hàng</label>
                                                </div>
                                                @endif
    ...
    <script type="text/javascript">
        ...
        $('#modal-list-image').on('hide.bs.modal', function () {
            ...
            for (var i = 0; i < img_list.length; i++) {
                _html += '<div class="col-md-3 thumbnail" style="margin-left: 20px">';
