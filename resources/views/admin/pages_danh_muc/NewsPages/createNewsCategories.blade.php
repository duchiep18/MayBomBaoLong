...
<section class="content">
        <div class="container-fluild">
            <h2 style="text-align:center">Chuyên mục tin tức - bài viết</h1>
                 <form action="{{route('news.storeCategories')}}" method="POST" role="form">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class ="col-xs-12 col-sm-12 col-md-5 col-lg-5" >
                                ...
                                <p><small>Tên</small></p>
                                <input type="text" name="tendanhmuc" class="form-control" style="background-color: white;margin-top: -10px;">
                                ...
                                <div style="margin-top: -10px;">
                                    <select class="form-control show-tick" name="loaidanhmuc">
                                ...
                                <div class="form-group" style="margin-top: -10px;">
                                    <div class="form-line">
                                        <textarea rows="4" name="motadanhmuc" class="form-control no-resize" style="background-color: white;"></textarea>
                                    </div>
                                </div>
