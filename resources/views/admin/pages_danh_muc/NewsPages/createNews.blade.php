...
@section('content')
    <section class="content">
            <h1 style="styletext-align:center">Thêm bài viết</h1>
                ...
                <div class="row">
                    <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-left: 0px;">
                            <input type="text" class="form-control" name="title" id="name" placeholder="Thêm tiêu đề"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5" style="padding-left:0">
                                <p>Url bài viết:</p>
                                <input type="text" name="url_post" id="slug" class="form-control"
                                ...
                                <div class="body" style="height:280px ">
                                    ...
                                    <div>
                                        ...
                                        <button type="submit" class="btn bg-blue btn-lg waves-effect"
                                                style="border-radius: 5px; margin: 5px 0 0px 10px; float: right">Đăng
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card" style="border: 1px solid #9E9E9E; border-radius: 10px">
                                ...
                                <div class="body">
                                    <div class="form-group demo-tagsinput-area">
                                        <div class="form-line">
                                            <input type="text" class="form-control" id="tags" name="tags_post">
                                        </div>
                                    </div>
                                </div>
                            </div>
