...
@section('content')
    ...
    <section class="content">
        <div class="container-fluild">
            <h1 style="text-align:center">Sửa đổi danh mục</h1>
...
{{--                            </div>--}}
{{--                            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9" style="margin-bottom: 15px; padding-left: 0px;">--}}
{{--                                <div class="hidden-xs hidden-sm" style="display: inline-block;width: 100%">--}}
{{--                                    <select class="form-control show-tick">--}}
{{--                                        <option>Trống</option>--}}
{{--                                        <option>Xóa</option>--}}
{{--                                    </select>--}}
{{--                                </div>--}}
{{--                                <p style="margin-bottom: 16px;"><small>Chỉ định một chuyên mục Cha để tạo thứ bậc. Ví dụ, bạn tạo chuyên mục Album nhạc thì có thể làm cha của chuyên mục Album nhạc Việt Nam và Album nhạc quốc tế.</small></p>--}}
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9" style="margin-bottom: 50px; padding-left: 0px;">
                                <div class="hidden-xs hidden-sm" style="display: inline-block;width: 100%">
                                    <select class="form-control show-tick" name="type_cat">
                                        ...
                                        <option value="10">Danh mục cha</option>
                                        <option value="20">Danh mục con</option>
                                    </select>
                                </div>
                            </div>
                        </div>
